// Taken from https://github.com/capt-nemo429/nautilus-wallet/blob/master/src/mappers/assetIconMap.ts
// Copyright (c) 2021 capt-nemo429
import { config } from '@config';

export const assetIconMap: Record<string, string> = {
  [config.ergTokenId]: 'ergo.svg',
